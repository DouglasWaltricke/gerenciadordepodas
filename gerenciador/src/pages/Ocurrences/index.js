...
export default function Ocurrences(){
    ...
    return(
        <View>
            <Text style={{textAlign:'center',fontSize:20,paddingTop:25}}>Ordens de serviço</Text>
                ...
                <FlatList data={ocorrencias} showsVerticalScrollIndicator={true} keyExtractor={ ocorrencia => String(ocorrencia.id) } onEndReached={loadOcurrences}
                    ...
                    <Card style={{marginTop:20}}>
                        <Card.Content>
                            ...
                            <Button icon="check-all" mode="text" onPress={() => handleFinishOcurrence(ocorrencia.id) } style={{alignItems:'flex-start'}}>
                                Concluir
                            </Button>
                        </Card.Content>
                    </Card>
